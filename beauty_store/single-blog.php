			...
			<?php 
				 ...
				 if (isset($_GET['id_blog'])) {
					$id_blog = $_GET['id_blog'];
                            ...
                            $load_blogs_query = mysqli_query($connection,$query);

                          

                           

                            $row = mysqli_fetch_array($load_blogs_query);
									...
									<div class="single-post row">
											<div class="col-lg-12">
													<div class="feature-img">
															<img class="img-fluid" src="img/blog/<?php echo $blog_img ?>" alt="<?php echo $blog_img ?>">
													</div>
											</div>
