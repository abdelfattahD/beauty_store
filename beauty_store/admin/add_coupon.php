...
if (isset($_POST['add_coupons'])) {
    ...
    if($check_coupons == 1){
        ...
        $insert_coupon = "INSERT INTO coupons (product_id, coupon_title, coupon_price, coupon_code, coupon_limit, coupon_used,coupon_type) VALUES ('$coupon_pro_id', '$coupon_title', '$coupon_price', '$coupon_code', '$coupon_limit', '$coupon_used','0')";
